...
lasts 1600ms, including a small radius overshoot. The roster has a 1800ms timeout
...
and reloads, old links, home navigation, the 1280px cap, sticky-title spacing,
About shader compilation and a transition, reduced motion, and mobile overflow.

The 1280px cap is restored relative to `mattfryed/modemode` base `52eb70c`.
